...
N 240 -600 320 -600 {
lab=VDDA}
C {sky130_stdcells/inv_2.sym} 160 -310 0 0 {name=X_inv_0 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfstp_1.sym} 390 -430 0 0 {name=X_upFF VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfstp_1.sym} 390 -190 0 0 {name=X_dwFF VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/xor2_1.sym} 230 -60 0 0 {name=x5 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 160 -450 0 0 {name=X_buf_3 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 380 -350 0 0 {name=X_buf_4 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 390 -60 0 0 {name=X_buf_5 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 330 -60 0 0 {name=l6 sig_type=std_logic lab=Dout}
C {sky130_stdcells/buf_2.sym} 160 -210 0 0 {name=X_buf_6 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/inv_2.sym} 380 -280 0 1 {name=X_inv_1 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {devices/ipin.sym} 240 -600 0 0 {name=p5 lab=VDDA}
C {devices/lab_wire.sym} 300 -600 0 0 {name=X_buf_1 sig_type=std_logic lab=VDDA}
