...
C {sky130_stdcells/xor2_1.sym} 230 -60 0 0 {name=x5 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 160 -450 0 0 {name=X_buf_3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 380 -350 0 0 {name=X_buf_4 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/buf_2.sym} 390 -60 0 0 {name=X_buf_5 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 330 -60 0 0 {name=l6 sig_type=std_logic lab=Dout}
C {sky130_stdcells/buf_2.sym} 160 -210 0 0 {name=X_buf_6 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/inv_2.sym} 380 -280 0 1 {name=X_inv_1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
