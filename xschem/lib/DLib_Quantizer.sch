...
N 240 -200 320 -200 {
lab=GND}
C {sky130_stdcells/dlygate4sd3_1.sym} 60 -40 0 0 {name=Xdly_1 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfxtp_1.sym} 210 50 0 0 {name=x2 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_2.sym} 60 60 0 0 {name=x3 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/nand2_1.sym} 520 60 0 0 {name=x4 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_2.sym} 640 60 0 0 {name=x5 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 590 60 3 0 {name=l1 sig_type=std_logic lab=FBack_inv}
C {sky130_stdcells/dlygate4sd3_1.sym} 160 -40 0 0 {name=Xdly_2 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 110 -40 3 0 {name=l2 sig_type=std_logic lab=DL1}
C {sky130_stdcells/dlygate4sd3_1.sym} 260 -40 0 0 {name=Xdly_3 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dlygate4sd3_1.sym} 360 -40 0 0 {name=Xdly_4 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 310 -40 3 0 {name=l3 sig_type=std_logic lab=DL3}
C {sky130_stdcells/dlygate4sd3_1.sym} 460 -40 0 0 {name=Xdly_5 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dlygate4sd3_1.sym} 560 -40 0 0 {name=Xdly_6 VGND=GND VNB=GND VPB=VDDA VPWR=VDDA prefix=sky130_fd_sc_hd__ }
...
C {devices/ipin.sym} 240 -230 0 0 {name=p5 lab=VDDA}
C {devices/ipin.sym} 240 -200 0 0 {name=p6 lab=GND}
C {devices/lab_wire.sym} 310 -230 0 0 {name=l7 sig_type=std_logic lab=VDDA}
